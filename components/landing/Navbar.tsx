      ...
      >
        <div className="flex items-center justify-between px-4 sm:px-6 h-16 sm:h-20">
          ...
          <Link href="/" className="flex items-center gap-3 group transition-transform duration-300 hover:scale-105">
            <img src="/images/logo.png" alt="OneClick Logo" width={42} height={42} className="rounded-xl" />
          ...
          {/* Desktop Button - Only Become Agent */}
          ...
          <div className="md:hidden border-t border-slate-800 bg-black/90 backdrop-blur-xl rounded-b-2xl px-6 pb-6 pt-4">
            <div className="flex flex-col gap-4">
              ...
              <div className="pt-4 border-t border-slate-800">
                <button
                  onClick={() => openAuthModal('register')}
                  className="w-full flex items-center justify-center gap-2 px-5 py-2.5 bg-linear-to-r from-orange-500 to-pink-500 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-orange-500/40 transition-all duration-300"
                >
                  <Users className="w-4 h-4" />
                  Become Agent
                </button>
